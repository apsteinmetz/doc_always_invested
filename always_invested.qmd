...
This document is a Quarto notebook using the R data science language. Code and data available at [https://github.com/apsteinmetz/doc_always_invested.git](https://github.com/apsteinmetz/doc_always_invested.git). Quarto is available from [Posit.co](posit.co)
:::
## Appendix
